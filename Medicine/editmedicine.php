...
{ 
    ...
    $expiredate=$_POST['expiredate'];
      ...
      $write =mysqli_query($connection,"UPDATE addnewmedicine SET name='$name',category='$category',price='$price',quantity='$quantity',genericname='$genericname',company='$company',effect='$effect',expiredate='$expiredate' WHERE id='".$_GET['id']."'") or die(mysqli_error($connection));
...
<div class="col-md-12">
    <div class="box box-primary">
            <div class="box-header with-border bg-blue">
             <i class="fa fa-plus"></i> <h3 class="box-title">Editar Medicamento</h3>
            </div>
        <form method="POST" >
              <div class="box-body">
...
while ($row1 =mysqli_fetch_array($res)) {
   echo $row1['category'];?>
<option value="<?php echo $row1['category'];?>"<?php if ($category==$row1['id']) {
...
<a href="medicinenamelist.php"><span class="btn btn-primary"><i class="fa fa-back"></i> Voltar<!--span class="popuptext" id="myPopup">Get full version at rogeriolameira@gmail.com</span--></span></a><!--&nbsp;&nbsp-->
