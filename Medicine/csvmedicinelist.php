...
$query=mysqli_query($connection,"SELECT `id`, `name`, `category`, `price`, `quantity`, `genericname`, `company`, `effect`, `expiredate` FROM addnewmedicine")or die (mysqli_error($connection));
