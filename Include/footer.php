  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 Desenvolvido por:<a href="">Consenci-</a>Consultoria de informática Tel: 944259591</strong> Todos Direitos Reservado
    ...
    $row2=mysqli_fetch_array($write1)or die (mysqli_error($connection));
       ?>
        ...
        },
        {
          ...
          url            : '../Appointment/allappointment.php',
