	        ...
	        <div class="card-body">
	            ...
	            <div class="chat-conversation">
	                ...
	                <form method="post" action="<?php echo site_url('admin/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row">
	                        <div class="col">
	                            <input type="text" name="message" class="form-control chat-input" placeholder="Digite Sua Mensagem" required>
	                            <div class="invalid-feedback">
	                                <?php echo get_phrase('Por favr escreva sua mensagem'); ?>
	                            </div>
	                        </div>
	                        <div class="col-auto">
	                            <button type="submit" class="btn btn-danger chat-send btn-block waves-effect waves-light"><?php echo get_phrase('Enviar'); ?></button>
	                        </div>
	                    </div>
	                </form>
