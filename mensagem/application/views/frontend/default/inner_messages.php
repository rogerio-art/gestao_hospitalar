<?php if (!isset($message_thread_code)): ?>
    <div class="text-center empty-box"><?php echo get_phrase('Selecione_uma_mensagem_para_ler_aqui'); ?>.</div>
<?php endif; ?>
<?php
    ...
    <div class="message-details d-show">
        ...
        <div class="message-footer">
            <form class="" action="<?php echo site_url('home/my_messages/send_reply/'.$message_thread_code); ?>" method="post">
                <textarea class="form-control" name="message" placeholder="<?php echo get_phrase('digite_sua_mensage'); ?>..."></textarea>
                <button class="btn send-btn" type="submit"><i class="far fa-send"></i><?php echo get_phrase('enviar'); ?></button>
            </form>
        </div>
    </div>
<?php endif; ?>
