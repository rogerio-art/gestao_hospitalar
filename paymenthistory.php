            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                    <i class="fa fa-money"></i> <h1 class="box-title"><b>Meus Pagamentos</b></h1>
                </div>
                <div>&nbsp;&nbsp;
        ...
        <td><?php if (!empty($row['depositammount']))
         {
            ...
            <?php }  ?><!-- a href="delete2.php?id=<?php //echo $row['id']; ?>"><span class="btn btn-danger"><i class="fa fa-trash-o"></i>Exc</span></a> -->

         <a href="printinvoice.php?id=<?php echo $row['id'];?>"> <button type="button" class="btn bg-blue"><i class="fa fa-print"></i>Imp</button></a></td>
    ...
    <tr>
      ...
      <?php  } ?>
...
</div><div class="alert alert-success alert-dismissible pull-right"style="width: 12%;" >
        ...
        <h4><i class="icon fa fa-money"></i> Valor</h4>
          ...
          //print_r($row3); exit;
          ?>
         <center><font size="5"> Kz. <?php echo $row3['subtotal'];?></font></center>
          </div>
