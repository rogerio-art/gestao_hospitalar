...
-->
 ...
 <div class="content">
   ...
   <section class="content">
    ...
    <form action="scriptlogin.php"  method="post" class="col-sm-8 offset-sm-2">
      <div class="row">
      <h1><i class="fa fa-user"></i>  <center>Login</h1></center>
      ...
      <input name="login" type="submit"  onclick="submit" id="log-btn" value="Entrar" STYLE = "color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #2196f3;" size = "10" maxlength = "30" class="form-control" class="btn btn-primary"  />
      
<center> <p>Regista se <a href="signup.php">Agora</a>?</p></center>
</div>
      </div>
    </form>
    </section>
