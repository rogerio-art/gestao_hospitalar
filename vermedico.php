...
<div class="sidebar">
  ...
  <div class="row">
    <div class="col-12">
    <h3><font color="bronw">Médicos Activos</font></h3>
      <table class="table caption-top table-sm table-hover table-bordered border-primary ">
        ...
        <tbody>
          ...
          <?php $sql= "SELECT  id_medico,nomemedico,emaildomedico,	numerodetelefone,morada,imagem from medicos ORDER BY id_medico DESC";
  ...
  if($result ->num_rows >0){
      ...
      echo "<tr><th>". $row["id_medico"] . "<th>".$row["nomemedico"]. "<th>".$row["emaildomedico"]. "<th>".$row["numerodetelefone"].
      " <th>".$row["morada"]." <th>".$row["imagem"];
