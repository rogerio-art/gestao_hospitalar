...
<link rel="stylesheet" type="text/css"  href="print.css" media="print">
   ...
   <!doctype html>
    ...
    <!-- The sidebar -->
                        ...
                        <?php $query1=mysqli_query($connection,"SELECT * FROM justify WHERE id='".$_GET['id']."'")or die (mysqli_error($connection));
...
<body>
  ...
  <div class="content-wrapper">
       ...
       <h1>
       <font color="black">Justificativo Médico</font>
         <small></small>
        </h1>
      <ol class="breadcrumb">
     ...
     <div class="row">
         ...
         <table class="table">
                     <thead>
                        ...
                        <th ><h3> <p><strong>Repouso Médica</strong></p></h3> </th>
 ...
 <div class="content">
    ...
    <?php } ?>
              ...
              <table   class="table table-bordered table-hover " >
                     ...
                     <tbody>
                     <th ><h3> <p><strong><center>Repouso Médico</center></strong></p></h3> </th>
                   

                                <tr>
                                <td ><center><?php echo $row['descriacao']. $row['patient']. $row['descricao2'].' '. $row['date']. $row['descricao3']. $row['data1'].' '. ' até ' .' '. $row['data2'] ;?> </center></td>
                                      </tr>
...
?>
           ...
           <?php echo $_SESSION['lname'];?>
                ...
                <div >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         ...
                         <a href=" ./justify.php"  class="btn bg-blue"></i>  Voltar</a>
