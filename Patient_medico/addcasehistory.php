             ...
             <i class="fa fa-edit"></i> <h3 class="box-title">Histórico do Paciente</h3>
              ...
              <div class="modal-body">
               <form method="POST" >
                  ...
                  <select name="patient" class="form-control select2" style="width:100%;" placeholder="Escolher">
                   <option >
<?php
...
<?php } ?> 
                ...
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="description" style="width:100%;" class="form-control">
                   ...
                   <div>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            <button type="submit"  name="submit" class="btn bg-blue">Salvar</button>
                   <a href="casehistory.php" class="btn bg-blue">Voltar</a>
                   </div>
