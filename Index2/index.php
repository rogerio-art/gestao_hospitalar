...
<section class="content-header">
    ...
    <h3><font color="#e90a0a ">Painel de Controle</font></h3>

        <small></small>
     
      <ol class="breadcrumb">
        <li> <a href="../Index2/index.php"><i class="fa fa-dashboard"></i> Início</a></li>
   ...
   //print_r($row); exit;
            ...
            <a href="../Exame/examelist.php" class="small-box-footer"> Mais informação  <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
