...
<!-- <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" style="height: 50px;"><i class="fa fa-plus-square"></i> Adicionar Novo</button><br>
...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header bg-blue" style="height: 60px">
      ...
      <h4 class="modal-title"> Adicionar Fichero</h4>
      </div>
...
<td><a href="./donwload.php?file=<?php echo $row['file'];?>"><button type="submit" class="btn btn-primary"><i class="fa fa-download"></i> Download</button></a>&nbsp;
